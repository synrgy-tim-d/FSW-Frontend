...
const SignIn = () => {
  return (
    <div className='container bg-white font-[Montserrat]'>
      ...
      <div className='flex flex-col justify-center h-[44px] w-[526px] mx-auto'>
        <a href='#' className='text-[16px] font-[600] text-left text-black hover:text-black'>Lupa Password</a>
      </div>
      ...
      <div className='flex flex-row justify-center mt-[16px]'>
        <p className='text-center text-black text-[16px] font-[600] w-[250px] h-[36px]'>
          Belum punya akun?{' '}
          <a className='text-black hover:text-black' href='/register'>
            Daftar
          </a>
        </p>
      </div>
