import nohistory from '../../../assets/img_noHistory.png';

export const HistoryOwnerNoData = () => {
  return (
    <div className='col-span-4 min-h-screen h-full px-5'>
      <div className='flex flex-row justify-center mt-52'>
        <img src={nohistory} className='' alt='Riwayat Masih Kosong' />
      </div>
      <div className='flex flex-row justify-center text-center mt-12'>
        <p className='text-[30px] font-[600]'>Riwayat transaksi masih kosong</p>
      </div>
      <div className='flex flex-row justify-center text-center mt-5'>
        <p className='text-[20px] font-[500] max-w-[550px]'>
          Belum ada yang memesan kos nih, bagikan dan promosikan halaman kosanmu!
        </p>
      </div>
