                ...
                <React.Fragment key={index}>
                  <div className='form-control p-2'>
                    <label className='flex select-none items-center cursor-pointer gap-3'>
                      ...
                      <span className='text-[14px] lg:text-[20px] font-[500]'>{month.name}</span>
                    </label>
                  </div>
                </React.Fragment>
              );
          ...
          >
            <div className='form-control p-2'>
              <label className='flex select-none items-center cursor-pointer gap-3'>
                ...
                <span className='text-[14px] lg:text-[20px] font-[500]'>2022</span>
              </label>
            </div>
            <div className='form-control p-2'>
              <label className='flex select-none items-center cursor-pointer gap-3'>
        ...
        return (
          <React.Fragment key={index}>
            <div className='flex flex-row mb-2 lg:mb-4'>
              <p className='font-[600] text-[14px] lg:text-[16px] text-[#0A008A]'>{date.date}</p>
            </div>
            {/* Konten Riwayat */}
                  ...
                  <React.Fragment key={index}>
                    <div className='flex flex-row gap-5'>
                      ...
                      <div className='flex flex-col text-left space-y-[-5px] lg:space-y-0'>
                        {/* Nama dan ID Desktop */}
                        <p className='hidden lg:block text-[14px] lg:text-[20px] font-[600] pb-2'>
                          {booking.name} [Booking ID: {booking.bookId}]
                        </p>
                        {/* Nama Mobile */}
                        <p className='lg:hidden text-[14px] lg:text-[20px] font-[600] pb-1'>
                          {booking.name}
                        </p>
                        {/* ID Mobile */}
                        <p className='lg:hidden text-[14px] lg:text-[20px] font-[600] pb-1'>
                        ...
                        <p className='text-[12px] lg:text-[16px] font-[600] lg:pb-1 text-[#4A4A4A]'>
                          Dipesan oleh {booking.rentor}
                        </p>
                        <p className='text-[10px] lg:text-[12px] font-[400] text-[#4A4A4A] pb-2 lg:pb-0'>
                          {booking.fullDate}
                        </p>
                        <div className='flex flex-row gap-2'>
                          <img className='w-[12px] lg:w-auto' alt='' src={icondownload} />
                          <p className='text-[10px] lg:text-[16px] font-[600] text-[#b6b6b9]'>
                            Download detail pembayaran
                          </p>
                        </div>
                      </div>
                      {/* Button Desktop */}
                      <div className='hidden lg:flex flex-col flex-1 gap-2 items-end'>
                    ...
                    {/* Button Mobile */}
                    <div className='lg:hidden flex flex-col flex-1 lg:gap-2 items-start'>
                      <p className='text-[14px] lg:text-[20px] font-[500] mt-2 lg:mb-1'>
                        Rp{booking.price}
                      </p>
                      {component}
                    </div>
                    <hr className='mt-3 lg:ml-[110px] mb-5 lg:mb-10'></hr>
                  </React.Fragment>
                );
              } else {
