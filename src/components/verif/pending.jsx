...
function EmailPending() {
  return (
    <div className='w-full flex flex-wrap gap-5 justify-center '>
      ...
      <p className='lg:w-1/2 w-[85%] mx-auto  lg:text-xl text-center font-semibold'>
        Link verifikasi akun telah kami kirimkan ke alamat email kamu, segera lakukan verifikasi
        untuk mendapat akses login, kemudian refresh halaman ini
      </p>
    </div>
  );
}
