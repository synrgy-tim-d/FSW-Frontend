    ...
    <>
      <div className='w-screen font-[Montserrat] font-[400] text-[#000000] text-[16px] p-8'>
        ...
        <div className='grid grid-cols-4 grid-flow-col gap-4'>
          <div className='col-span-3 grid grid-rows-auto auto-rows-max gap-8 p-4'>
              ...
              <div className='col-span-2 grid grid-rows-auto grid-flow-row gap-2 p-4'>
                <div className='grid grid-flow-col'>
                  <div className='grid grid-cols-auto grid-flow-col auto-cols-max content-center'>
                    <div className='p-2 border-2 border-[#0A008A] rounded-[150px]'>Campuran</div>
                    <span className='text-[#BA1A1A] italic pl-2 self-center'>sisa 3 kamar</span>
                  </div>
                ...
                <div className='grid grid-cols-auto grid-flow-col auto-cols-max gap-2 content-center'>
                  ...
                  <p className='font-[500]'>Yogyakarta</p>
                </div>
