...
const InitialAddKostState = {
  ...
  kostFaqAnswer2: null,
  kostFrontPhoto: null,
  kostFrontPhotoURL: null,
  kostFrontPhoto2: null,
  kostFrontPhotoURL2: null,
  kostBackPhoto: null,
  kostBackPhotoURL: null,
  kostBackPhoto2: null,
  kostBackPhotoURL2: null,
...
export const AddKostActions = {
  ...
  SET_KOST_FRONT_PHOTO_URL: 'SET_KOST_FRONT_PHOTO_URL',
  SET_KOST_FRONT_PHOTO_2: 'SET_KOST_FRONT_PHOTO_2',
  SET_KOST_FRONT_PHOTO_URL_2: 'SET_KOST_FRONT_PHOTO_URL_2',
  SET_KOST_BACK_PHOTO: 'SET_KOST_BACK_PHOTO',
  SET_KOST_BACK_PHOTO_URL: 'SET_KOST_BACK_PHOTO_URL',
  SET_KOST_BACK_PHOTO_2: 'SET_KOST_BACK_PHOTO_2',
  SET_KOST_BACK_PHOTO_URL_2: 'SET_KOST_BACK_PHOTO_URL_2',
...
const AddKostReducer = (state, action) => {
  switch (action.type) {
    ...
    case AddKostActions.SET_KOST_FRONT_PHOTO_URL:
      return { ...state, kostFrontPhotoURL: action.payload };
    case AddKostActions.SET_KOST_FRONT_PHOTO_2:
      return { ...state, kostFrontPhoto2: action.payload };
    case AddKostActions.SET_KOST_FRONT_PHOTO_URL_2:
      return { ...state, kostFrontPhotoURL2: action.payload };
    case AddKostActions.SET_KOST_BACK_PHOTO:
      return { ...state, kostBackPhoto: action.payload };
    case AddKostActions.SET_KOST_BACK_PHOTO_URL:
      return { ...state, kostBackPhotoURL: action.payload };
    case AddKostActions.SET_KOST_BACK_PHOTO_2:
      return { ...state, kostBackPhoto2: action.payload };
    case AddKostActions.SET_KOST_BACK_PHOTO_URL_2:
      return { ...state, kostBackPhotoURL2: action.payload };
